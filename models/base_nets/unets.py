...
class unet_a(unet_type1):
    def __init__(self, sync=False):
        super().__init__(n_inp=1, feats=[8, 32, 128, 128, 128, 256, 256], sync=sync)


class unet_a_sync(unet_type1):
    def __init__(self, sync=True):
        super().__init__(n_inp=1, feats=[16, 32, 128, 128, 128, 128, 128], sync=sync)
