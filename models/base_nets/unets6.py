...
class unet_type6(nn.Module):
    def __init__(
        ...
        super(unet_type6, self).__init__()
        ...
        self.rconvTlayer7_bn = abnblock(feats[6])
...
class unet_c1_e_sync(unet_type6):
...
class unet_c1_f_sync(unet_type6):
    def __init__(self, sync=True):
        super(unet_c1_f_sync, self).__init__(
            n_inp=1, n_out=4, feats=[16, 64, 128, 128, 128, 256, 512], sync=sync
        )
        # [16, 64, 128, 128, 128, 256, 512]
        # [32, 64, 64, 64, 128, 256, 512]
