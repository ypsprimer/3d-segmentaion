...
class unet_type_liver_thin(nn.Module):
    def __init__(
        self,
        n_inp=1,
...
class unet_a_liver_thin(unet_type_liver_thin):
    def __init__(self, abn=1):
        super().__init__(n_inp=1, feats=[32, 32, 64, 64, 128, 128, 128], abn=abn)


class unet_a_liver_thin_sync(unet_type_liver_thin):
    def __init__(self, abn=2):
        super().__init__(n_inp=1, feats=[32, 32, 64, 64, 128, 128, 128], abn=abn)

class unet_a_liver_thin_sync_plus(unet_type_liver_thin):
    def __init__(self, abn=2):
