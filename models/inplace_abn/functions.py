...
class InPlaceABN(autograd.Function):
    ...
    def backward(ctx, dz):
        ...
        if ctx.training:
            ...
            edz = dz.new_zeros(dz.size(1)).float()
            eydz = dz.new_zeros(dz.size(1)).float()
        #print(z.dtype, 'z')
        #print(dz.dtype, 'dz')
        #print(var.dtype, 'var')
        #print(weight.dtype, 'weight')
        #print(bias.dtype, 'bias')
        #print(edz.dtype, 'edz')
        #print(eydz.dtype, 'eydz')
        #print(ctx.affine.dtype, 'ctx.affine')
        #print(ctx.eps.dtype, 'ctx.eps')
